...
AFRAME.registerComponent('content-group', {
  ...
  initLayout: function () {
    ...
    this.contentElements.forEach(function (el, index) {
      ...
      let contentHeight = contentComponent.getHeight(); // console.log("content height ", contentHeight);
      // console.log(self.spacing);

      el.object3D.position.y = contentHeightSoFar; // Content grows down

      contentHeightSoFar += -self.spacing - contentHeight; // console.log("content height so far: ", contentHeightSoFar);
    });
  },
...
//# sourceMappingURL=content-group.5683148b.js.map