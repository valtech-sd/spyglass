...
ready(async function () {
  ...
  const {
    ingredientURLs
  } = (0, _getAssetURLs.default)(_data_sources.default); // console.log('ingredientURLs:', ingredientURLs); 
...
},{"../js/data_sources":"tBe1","../utils/getAssetURLs":"WonQ","../utils/buildDynamicAssets":"P96M","../utils/createNavLinks":"QOCG","../utils/detectDesktop":"Ony6","../utils/makePanel":"TNkT"}]},{},["cN1f"], null)
